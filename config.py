...
ID_PASTA_TEMPLATES_DRIVE = os.environ.get('ID_PASTA_TEMPLATES_DRIVE', '1tNN4b4FDeMNfeOI8kHWGku4qcWyrg2vz')
...
ID_PLANILHA_PROJETOS_SECUNDARIA = os.environ.get('ID_PLANILHA_PROJETOS_SECUNDARIA', '18H4AcuSG5auI7mi3KFV9nrJSx70zR9UK')
...
ZOHO_TEMPLATE_ID_PADRAO = os.environ.get('ZOHO_TEMPLATE_ID_PADRAO', '2376502000007609158')
